...
def find_closed_facilities(active_year_before, active_year_after, year):
    '''
    ...
    result['SUS_YEAR'] = year
    return result


# Apply to each year from 2017 to 2019
closed_2017 = find_closed_facilities(active_2016, active_2017, 2017)
closed_2018 = find_closed_facilities(active_2017, active_2018, 2018)
closed_2019 = find_closed_facilities(active_2018, active_2019, 2019)
# Concatenate all closed facilities into one DataFrame
...
for zip_code in zip_closed_2017:
  zip_count_2016 = len(active_2016[active_2016['ZIP_CD'] == zip_code])
  zip_count_2018 = len(active_2018[active_2018['ZIP_CD'] == zip_code])
  if zip_count_2016 <= zip_count_2018:
...
for zip_code in zip_closed_2018:
  ...
  if zip_count_2017 <= zip_count_2019:
